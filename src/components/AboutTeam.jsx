    ...
    <div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div>
                ...
                <p className="mx-6 my-5">
                Kyra Rénel is an impact-seeking business strategist and transformative leader with a track record of driving organizational growth, efficiency, and profitability. As the founder of The Kyra Company, LLC,
                she empowers businesses to optimize their operations and maximize impact. Known for her strategic brilliance and operational expertise, Kyra has built high-performing teams and streamlined processes for top companies across industries. An author, speaker,
                and thought leader, Kyra has a unique ability to inspire and ignite action through dynamic keynotes and impactful panel moderation. Her talent for leading with transparency, building alliances, and fostering collaboration makes her a sought-after voice in
