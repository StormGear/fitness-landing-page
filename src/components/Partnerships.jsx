    ...
    <div className='bg-white border-t-2 border-b-2 border-black p-6 flex justify-between'>
      ...
      <div className='md:flex flex-col items-center justify-center'>
          ...
          <p>With ConfiHealthFit’s expert guidance, you’re not just taking a supplement—you’re getting a proven strategy to support your metabolism, balance your hormones, and finally see the weight loss results you deserve. </p>
            <p className="mt-5 flex justify-center animate__animated animate__pulse animate__infinite font-bold text-xl ml-5 cursor-pointer">➡ &nbsp;<a href="https://secure.gethealthie.com/appointments/embed_appt?dietitian_id=3709145&require_offering=true&provider_ids=[3709145]&offering_ids=[180865]&hide_package_images=false&primary_color=16284A
" target="_blank">[Book Your Consultation Now]</a> </p>
